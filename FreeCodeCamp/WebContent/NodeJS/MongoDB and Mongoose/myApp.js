...
var createAndSavePerson = function(done) {
    ...
    var document = new Person({name: 'Gautham', age: 28, favoriteFoods: ['Pizza', 'Burger', 'Chicken']});
...
var arrayOfPeople = [{name: 'Gautham', age: 28, favoriteFoods: ['Pizza', 'Burger', 'Chicken']},
                     {name: 'Manoj', age: 23, favoriteFoods: ['Rice', 'Rasam', 'Potato']},
                     {name: 'Karthik', age: 18, favoriteFoods: ['Pasta', 'Curd', 'Pongal']} ];
...
var findAndUpdate = function(personName, done) {
  var ageToSet = 20;
  Person.findOneAndUpdate({name: personName}, {age: ageToSet}, {new: true}, (err, newPerson) => {
...
var removeManyPeople = function(done) {
  ...
  Person.remove({name: nameToRemove}, (err, resObj) => {
...
var queryChain = function(done) {
  ...
  let burrQuery = Person.find({favoriteFoods: foodToSearch}); //Without callback returns a query. Can be chained.
