 ...
 * Generated at: 2020-05-28 14:16:15 UTC
...
public final class thankyou_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("file:/Users/admin/.m2/repository/javax/servlet/jstl/1.2/jstl-1.2.jar", Long.valueOf(1589961612000L));
    _jspx_dependants.put("jar:file:/Users/admin/.m2/repository/javax/servlet/jstl/1.2/jstl-1.2.jar!/META-INF/c.tld", Long.valueOf(1153365282000L));
    _jspx_dependants.put("jar:file:/Users/admin/.m2/repository/javax/servlet/jstl/1.2/jstl-1.2.jar!/META-INF/fmt.tld", Long.valueOf(1153365282000L));
  }
...
return;
    ...
    try {
      ...
      out.write(" <!--  prefix='c' is the local variable for the library -->\n");
      out.write(" <!--  format library of JSTL -->\n");
      out.write("\n");
      out.write("<html>\n");
      out.write("\t<body>\n");
      out.write("\t\t");
      ...
      out.write("\t\t<!-- Writing AJAX call to server -->\n");
      out.write("\t\t\n");
      out.write("\t\tfunction updateStatus()\n");
      out.write("\t\t{\n");
      out.write("\t\t    var request = new XMLHttpRequest();\n");
      out.write("\t\t    // client CALLBACK checking for successful response from server\n");
      out.write("\t\t    request.onreadystatechange = function() {  // Don't use arrow functions in AJAX\n");
      out.write("\t\t        if(this.readyState == 4)\n");
      out.write("\t\t        {\n");
      out.write("\t\t        \tlet resp = JSON.parse(this.responseText);\n");
      out.write("\t\t            document.getElementById(\"status\").innerHTML = resp['status'];\n");
      out.write("\t\t            document.getElementById(\"time\").innerHTML = \"Last updated \" + resp['time'];\t            \n");
      out.write("\t\t        }\n");
      out.write("\t\t    }\n");
      out.write("\n");
      out.write("\t\t    request.open(\"GET\", \"/updateStatus?id=");
      ...
      out.write("\t\t}, 2000); */ // setInterval outside the function updateStatus(), else won't be invoked automatically.\n");
      out.write("\t\t\n");
      out.write("\t\t</script>\n");
      out.write("\t\t\n");
      out.write("\t\t<!--  Using 'out' tag from tag library. Prints value to screen -->\n");
      out.write("\t\t\n");
      out.write("\t\tThank you - your order has been received. You need to pay\n");
      out.write("\t\t\n");
      out.write("\t\t<!-- Formatting for total(present in request object). \n");
      out.write("\t\t\t Formatting type is 'currency'(gives currency symbol for currencyCode we set in servlet.\n");
      out.write("\t\t\t CurrencyCode is set in servlet request object. (INR or USD etc)\n");
      out.write("\t\t\t-->\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t");
      ...
      out.write("\t\t\n");
      out.write("\t\t\n");
      out.write("\t\t<p> Current status of your order <span id=\"status\">");
  ...
  private boolean _jspx_meth_fmt_005fsetLocale_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /thankyou.jsp(44,2) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_fmt_005fformatNumber_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /thankyou.jsp(45,2) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    // /thankyou.jsp(45,2) name = type type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
