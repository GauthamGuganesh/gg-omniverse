...
class MyStringBuilder // extends StringBuilder
{
  ...
  /* Adapter part - start. Getting stringBuilder object and adapting some functionality */
  ...
  //Decorator part. Methods have to be fluent. Should return 'this' instead of StringBuilder.
