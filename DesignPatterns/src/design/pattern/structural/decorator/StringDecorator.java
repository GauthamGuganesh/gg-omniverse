...
{
	private String string; //Since string cannot be extended as it is final.
	
	public StringDecorator(String s)
	{
		this.string = s;
	}

	public long numberOfVowels() //Additional functionality added without inheriting string.
	{
		return string.chars()
				     .mapToObj(c -> (char)c)
	...
	//Delegated methods from Source->Generate Delegate methods
	...
	public static void main(String[] args) {
		StringDecorator magicString = new StringDecorator("hello");
