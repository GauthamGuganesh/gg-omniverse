...
{
  private int [] stats = new int[3]; //Having array backed properties is easy to maintain especially when we have
  //aggregate functions like sum,average.
  //We can make it implement iterable and go through the properties. Very convenient.
  ...
  //Aggregate functions like these are easier/scalable with array backed properties. 
  public int sum()
  {
